...
class FoodGoogleMapScreen extends StatefulWidget {
  const FoodGoogleMapScreen({super.key});
...
class _FoodGoogleMapScreenState extends State<FoodGoogleMapScreen> {
  ...
  Future<void> _getNearbyHospitals(double latitude, double longitude) async {
    final placesApiUrl =
        "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=$latitude%2C$longitude&radius=2000&type=restaurant&key=AIzaSyCWc32AivTpwqKcVQ6Z32l4NupqdBs_-1w";
